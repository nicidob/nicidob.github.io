...
The methods here are the same [as in my previous writeup](https://nicidob.github.io/cso_elo/). I download an export of [Liquipedia](https://liquipedia.net/arenafps/Main_Page) and build an Elo rating system from the historical data. The data is imperfect, with missing events and likely a few errors, but it'll have to do. In this case, [I added](https://liquipedia.net/arenafps/Special:Contributions/Nicidob) an extra 40 tournaments of match data to the wiki myself, just to patch up some holes. 

For ArenaFPS I found that combining ratings across games a significantly better log likelihood model, so it's what I'm using. One change that improved my results: when you switch games, you get 70% of your current Elo (across all games) and 30% of your last Elo in that game (which is the default 1,500 if you've never played it before). This setting (and the 17 others used in my Elo algorithm) are set by optimizing the settings to produce good probabilities and accurately predict matches. Higher tier events, higher tier players and LAN events get larger weight in the scoring function. The 18 parameters include separate \\(K\\) factors for Online, Offline and Tier-1 events. They also include nonlinear responses, degrading player ratings due to lack of recent results, factoring in scoring margin, using rating differences instead of a constant, etc. The algorithm is overdesigned with extra settings and the optimization algorithm decides how much to turn each dial such that the result is maximally accurate at predicting matches. 

My final result are a little more accurate (70%) than comparable Elo models for [NBA basketball](https://nicidob.github.io/nba_elo/) (67%) or [Counter-Strike](https://nicidob.github.io/cso_elo/) (66%). 

## The Big Picture
<p align="center">
  <img src="/images/1v1.png">
</p>
For every year, the top players (based on an annual Quadratic Mean of their Elo updates), across all arenaFPS games were
* **1998**	rix (1591), gollum (1589), thresh (1560), lordvader (1558), reptile (1543)
* **1999**	rix (1604), lakerman (1580), kane (1571), sectopod (1528), columbo (1518)
* **2000**	fatal1ty (1739), zero4 (1651), makaveli (1633), lakerman (1631), polosatiy (1589)
* **2001**	zero4 (1785), fatal1ty (1767), lakerman (1721), czm (1649), stelam (1643)
* **2002**	zero4 (1794), fatal1ty (1720), lexer (1703), gitzzz (1688), python (1658)
* **2003**	zero4 (1763), gitzzz (1750), fatal1ty (1728), unkind (1727), lexer (1721)
* **2004**	cooller (1812), gitzzz (1793), zero4 (1786), z4muz (1744), lauke (1730)
* **2005**	vo0 (1931), fatal1ty (1863), cooller (1813), zyz (1784), stermy (1780)
* **2006**	toxjq (1870), cooller (1826), czm (1822), fatal1ty (1801), stermy (1791)
* **2007**	toxjq (2016), av3k (1861), cooller (1836), fojji (1811), stermy (1801)
* **2008**	toxjq (1887), cypher (1830), czm (1830), av3k (1802), cooller (1794)
* **2009**	cypher (1831), rapha (1823), dahang (1752), av3k (1749), cooller (1740)
* **2010**	rapha (1896), cypher (1888), cooller (1861), av3k (1821), dahang (1763)
* **2011**	cypher (1922), rapha (1901), cooller (1881), strenx (1848), dahang (1839)
* **2012**	rapha (1973), cypher (1965), av3k (1878), dahang (1857), spart1e (1786)
* **2013**	cypher (1978), rapha (1976), av3k (1898), dahang (1883), evil (1815)
* **2014**	cypher (2035), rapha (1994), dahang (1896), evil (1865), strenx (1831)
* **2015**	cypher (2046), evil (1859), k1llsen (1749), fazz (1637), pavel (1568)
* **2016**	rapha (1994), evil (1870), spart1e (1789), k1llsen (1763), zero4 (1757)
* **2017**	cypher (1891), rapha (1838), dahang (1772), av3k (1769), cooller (1755)
* **2018**	rapha (1910), cypher (1906), k1llsen (1812), cooller (1782), dahang (1767)
* **2019**	rapha (1979), cypher (1878), k1llsen (1813), cooller (1801), vengeurr (1796)
* **2020**	rapha (1983), cypher (1882), raisy (1824), vengeurr (1798), k1llsen (1797)

Of the last 12 years, **rapha** and **cypher** share 22 of the 24 top spots, each being 1st six times. **Evil** sneaks into the top2 in 2015 and 2016. **Toxjq**'s peak in 2007 (of 2016 aQM Elo) is the highest on this list, and his dominance in Quake 4 is hard overstate. **Vo0** and **fatal1ty** reach high peaks in 2005 as the CPL Painkiller World Tour takes place. Vo0's 1931 Elo is the highest outside of toxjq, rapha and cypher. **Cooller** only leads in 2004 (although 2005 has him as the top Quake player), but he reaches the top5 eleven times. **GitzZz**'s strong play in Unreal Tournament gives him spot in 2002, 2003 and 2004 and **Lauke** joins him in 2004. In Quake 3, **ZeRo4** dominates the peak years, from 2001 to 2003. **Fata1lty** has his one year of Quake3 reign in 2000. In my data, **RiX**'s QuakeCon and CPL wins in 1998 and 1999 give him the top spot. **Av3k** gets as high as #2 in the Quake 4 era and has six years in the top5. **DaHanG** makes the list eight times.

Another way to look at top players is by their overall peaks. As usual, players' peaks are right before they start to lose games, otherwise it wouldn't be a peak. 

| Player           | Date        | Elo  | Game                                   |
|----------------|-------------|------|-------------------------------------------|
| toxjq       | 2007-08-24 | 2052 | Quake 4        |
| cYpheR    | 2014-07-18 | 2046 | Quake Live          |
| Fatal1ty      | 2005-11-21 | 2029 | Painkiller      |
| rapha         | 2013-11-29 | 2012 | Quake Live        |
| Vo0         | 2005-10-21 | 2006 | Painkiller        |
| | | | |
| rapha         | 2020-05-03 | 2002 | Quake Champions        |
| cYpheR         | 2018-09-09 | 1965 | Quake Champions        |
| av3k         | 2007-11-10 | 1946 | Quake 4        |
| ztrider         | 2005-11-21 | 1942 | Painkiller        |
| Cooller         | 2011-03-03 | 1922 | Quake Live         |
| | | | |
| av3k         | 2013-11-29 | 1908 | Quake Live         |
| DaHanG         | 2013-08-02 | 1907 | Quake Live         |
| Cooller         | 2007-08-24 | 1893 | Quake 4         |
| Evil         | 2016-08-05 | 1877 | Quake Live         |
| RAISY         | 2018-11-04 | 1875 | Quake Champions         |

Breaking 2000 in this system is incredibly rare. Toxjq in Quake4, cYpheR and rapha in Quake Live and Fatal1ty and Vo0 in Painkiller were the only ones to get there until rapha in Quake Champions this year. As players continue to play, the average Elo rating can tend to grow. Perhaps that's why we see no Quake 3 peaks on this list (highest ones were ZeRo4, Fatal1ty and Cooller with scores of 1852, 1848 and 1842 in August 2002, Dec 2000 and July 2005). The peaks in Unreal are GitzZz and Lauke with 1811 and 1808 in July 2004 and March 2005. 
...
For the first year of Quake 3, **Fatal1ty** is the dominant player, peaking during MPlayer CPL Cologne. The week after is Babbage's CPL, where **ZeRo4** wins. ZeRo4 has a dominant streak through 2002, but **uNkind** and **LeXeR** win WCG and QuakeCon. **Cooller** becomes the next dominant player, winning every major tournament he enters in 2003, staying top 3 during 2004 and winning ESWC 2005. **czm** gets second in ESWC 2004, wins Quakecon 2004, gets 2nd in ESWC 2005 and wins CPL Winter 2006, finally taking the crown. **Z4muZ** had some strong showings as well, getting second in QLAN, Wipeout and QuakeCon 2003, but peaking during QLAN2, after beating Cooller and czm.
### Unreal Tournament 
<p align="center">
  <img src="/images/unreal.png">
</p>

I combined results from UT99, Ut2k3 and Ut2k4. **GitzZz** is the clearly dominant player in the early WCG events. **Fatal1ty** wins an awkward CPL event, gets a decent finish in cXg, and still gets some credit for being dominant in Quake 3. **Lauke** eventually wins enough events to overtake GitzZz. **Burnie** also makes a good climb in 2004. 
...
With so many events, we have a high climb to huge Elo peaks (over 2000!). **Vo0** is the clear leader until the final few months, eventually falling to **Fatal1ty** during the CPL Finals. **Ztrider** wins the final CPL event (Chile), gaining plenty of Elo in a tournament many players didn't take seriously so close to the Finals. **ZyZ**, **stermy** and **gellehsak** win enough games to take the final three slots.
...
Quake 4 is a game dominated by **toxjq**. While **Cooller** wins the first few events, toxjq soon begins to dominate every event. He drops a best-of-three to **Fatal1ty** in the Finals, before winning the final set. **Av3k** begins to challenge **toxjq** as the game comes to an end in 2007. **fojji** plays well throughout Quake 4, and **DaHanG** begins to show up as a top player as well. Toxjq's peaks during Quake 4 are also past 2,000 Elo, a rare mark. 
...
**cYpheR** and **rapha** continue to be the two to beat, with the former being favored early in Quake Champion's timeline and the latter being favored more recently. **Cooller** is a top 5 player throughout, peaking in late 2018. **k1llsen**'s success brings him into the top 3 for most of 2018. **RAISY** and **vengeurr** appear on this list for the first time, perhaps the first of a new generation of Quake player. 
...
**Vo0** made a big splash. He has earned $280,000 playing 1v1 ArenaFPS games; second only to Fatal1ty. The CPL World Tour was the biggest ArenaFPS competition held to date, and Vo0 dominated it. Many great players tried their hand but Vo0 usually won. Most of his earnings come from Painkiller, a flawed game (as noted above). But he earned success of prestige variety as well, as perhaps the best [Q3 CPMA](https://en.wikipedia.org/wiki/Challenge_ProMode_Arena) player of all-time. Did Vo0 help sustain and elevate that community, such that PQL was added to Quake Live? Such that high mobility champions were added to Quake Champions? We'll never know but I suspect Vo0 may have played a role as popularizer. At the CPL World Tour 2005 Finals, the biggest prize pool ever awarded for 1v1, Vo0 takes second place. Twelve years later, at the Quake World Championship 2017, the second biggest prize pool ever awarded for 1v1, Vo0 takes second place again, above Cooller, rapha, toxjq, evil and several others. He beats Av3k, k1llsen and DaHanG. Vo0 clearly has the talent and ability to be a top10 player and managed to show it off a few times. 
...
czm's top10 case hinges on being a successful Quake 3 player at the right time, which is why he gets the last spot on the list. He was a precise player, with solid aim and impeccable timing. He was [unstoppable on Aerowalk](http://esreality.com/post/809489/will-czm-lose-on-aerowalk/). His [demanding career](https://people.math.ethz.ch/~nelsonpa/cv) often kept him from practicing as much as the others on this list, but he won plenty. At Babbage's CPL he knocks out Fatal1ty, at QCon 02 Fatal1ty returns the favor. By QCon 03, he's playing ZeRo4 in the winners bracket finals. QCon 04, he plays ZeRo4 in the winners bracket finals again, losing, again. But this time he crushes Cooller in Lower Bracket and beats ZeRo4 wins twice to win. In the final CPL event, he wins again, beating Cooller and Jibo. For 10 years, from the start of Quake 3 thru several years of Quake Live, he showed up. And for a few of those years, he was the best player in that important game. 

I think era matters. [Jared Dudley](https://www.basketball-reference.com/players/d/dudleja01.html) may have better 2pt and 3pt shooting splits than [Larry Bird](https://www.basketball-reference.com/players/b/birdla01.html) (and earned more money, even adjusted for inflation), but Larry Bird is one of the greatest shooters of all time. czm is one of the ten greatest players. 
...
**[evil](https://liquipedia.net/arenafps/evil)** broke through the wall that was cYpheR and Rapha. He has Russian LAN wins over Cooller as far back as 2004, but he's fairly low profile until 2012. He wins DreamHack Summer 2012 over rapha (3-1) and cYpheR (3-2). In QuakeCon 2013, he pushes rapha to 5 maps in the finals. In QuakeCon 2015 he pushes rapha to maps won by a single point. In 2016, he takes rapha to 5 maps in the finals. He may be the number 3 in Quake Live.
...
Now for a few that caught my eye: **[stermy](https://liquipedia.net/arenafps/stermy)** was the third-best Painkiller player and won $120,000 from that game alone. Decent finishes in Quake 4 Duel (stopped by toxjq at WSVG) and Quake Live Duel (beats rapha in QCon 2010) hint at his general ability.  **[Spart1e](https://liquipedia.net/arenafps/Spart1e)** has top2 finishes in 08/09/10; he falls back to several top 8 finishes in 11/12/13/14/16/18. **[Python](https://liquipedia.net/arenafps/Python)** had several top 10 finishes in Quake 3 from 2000 to 2006 and takes evil to 5 maps in QuakeCon 2016. **[Jibo](https://liquipedia.net/arenafps/Jibo)** was a top 20 player from 2002 to 2008 and was a regular threat to beat great players. 